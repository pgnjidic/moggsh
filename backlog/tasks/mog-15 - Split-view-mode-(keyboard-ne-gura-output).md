...
Claude Code ispisuje 300 linija, korisnik skrola gore, tap input field,
keyboard se otvori — terminal output iznad ostaje vidljiv.
FAB se pojavi, tap → skoči na zadnji prompt.
